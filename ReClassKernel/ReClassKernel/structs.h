...
} IMAGE_NT_HEADERS64, *LPIMAGE_NT_HEADERS64;
...
} IMAGE_NT_HEADERS32, *LPIMAGE_NT_HEADERS32;
...
//Non PE32-64 Structs
typedef union _PS_PROTECTION //used in win8.1+
{
	UCHAR Level;
	struct {
		INT Type : 3;
...
typedef struct _SYSTEM_SERVICE_DESCRIPTOR_TABLE
{
	...
	ULONG POINTER_ALIGNMENT ServiceCount;
